...
class CollaborativeMemoryNetwork(ModelBase):
    ...
    def _construct(self):
        ...
        # Positive : apply memory_layer, in '_build()'
        ...
        # Negative : apply memory_layer, in '_build()'
        ...
        # Loss and Optimizer
        self.loss = LossLayer()(self.score, negative_output, self.pos_unpop_mtc, self.neg_unpop_mtc)
    ...
    def _construct_placeholders(self):
        ...
        self.pos_unpop_mtc = tf.placeholder(tf.float32, [None], 'pos_unpop_mtc')
        
        self.neg_unpop_mtc = tf.placeholder(tf.float32, [None], 'neg_unpop_mtc')
    ...
    def _construct_weights(self):
        ...
        '''  Customized module defined in attention.py  '''
